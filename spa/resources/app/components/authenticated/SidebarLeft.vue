<template>
	<div>
		<div class="fixed-sidebar left">
			<div class="menu-left">
				<ul class="left-menu ps-container ps-theme-default ps-active-y" data-ps-id="2a21bf13-3126-03b7-e790-e8e6dfd0a853">
					<li>
					...
					<li>
						<router-link :to="{ name: 'home' }" title="Newsfeed Page" data-toggle="tooltip" data-placement="right">
							<i class="ti-magnet"></i>
						</router-link>
					</li>
					<li>
						<router-link :to="{ name: 'forum' }" title="Forum" data-toggle="tooltip" data-placement="right">
							<i class="fa fa-forumbee"></i>
						</router-link>
					</li>
					<li>
						<router-link :to="{ name: 'profile-friend-list', params: { username: getUsernameOfCurentUser } }" title="Friends" data-toggle="tooltip" data-placement="right">
							<i class="ti-user"></i>
						</router-link>
					</li>
					<li>
						<router-link :to="{ name: 'page', params: { slug: getSlugForPageOfCurrentUser } }" title="Favourit page" data-toggle="tooltip" data-placement="right">
					...
					<div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 494px; right: 0px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 446px;"></div></div></ul>
			</div>
			<div class="left-menu-full">
				<ul class="menu-slide ps-container ps-theme-default" data-ps-id="24a7b4e0-623c-4ebb-4c4d-ec62ceaa4aec">
...
export default Vue.extend({
	...
	computed: {
		getUsernameOfCurentUser() {
			return 'idk'
		},

		getSlugForPageOfCurrentUser() {
			return 'idk'
		}
	}
