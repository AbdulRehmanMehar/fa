			...
			<div class="col-lg-8 col-md-8">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="gen-metabox no-margin">
								...
								<ul class="badged">
									<li><img src="/static/images/badges/badge2.png" alt=""></li>
									<li><img src="/static/images/badges/badge19.png" alt=""></li>
									<li><img src="/static/images/badges/badge21.png" alt=""></li>
									<li><img src="/static/images/badges/badge3.png" alt=""></li>
									<li><img src="/static/images/badges/badge4.png" alt=""></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="central-meta">
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="fav-play">
								<figure>
									<img src="/static/images/resources/tvplay1.jpg" alt="">
								</figure>
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="fav-play">
								<figure>
									<img src="/static/images/resources/tvplay2.jpg" alt="">
								</figure>
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="fav-play">
								<figure>
									<img src="/static/images/resources/tvplay3.jpg" alt="">
								</figure>
				...
				<div class="central-meta">
					...
					<ul class="photos-list">
						<li>
							<div class="item-box">
								<a class="strip" href="/static/images/resources/photo-22.jpg" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
									<img src="/static/images/resources/photo2.jpg" alt=""></a>
						...
						<li>
							<div class="item-box">
								<a class="strip" href="/static/images/resources/photo-33.jpg" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
									<img src="/static/images/resources/photo3.jpg" alt=""></a>
								<div class="over-photo">
						...
						<li>
							<div class="item-box">
								<a class="strip" href="/static/images/resources/photo-44.jpg" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
									<img src="/static/images/resources/photo4.jpg" alt=""></a>
								<div class="over-photo">
						...
						<li>
							<div class="item-box">
								<a class="strip" href="/static/images/resources/photo-55.jpg" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
									<img src="/static/images/resources/photo5.jpg" alt=""></a>
								<div class="over-photo">
						...
						<li>
							<div class="item-box">
								<a class="strip" href="/static/images/resources/photo-66.jpg" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
									<img src="/static/images/resources/photo6.jpg" alt=""></a>
								<div class="over-photo">
						...
						<li>
							<div class="item-box">
								<a class="strip" href="/static/images/resources/photo-77.jpg" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
									<img src="/static/images/resources/photo7.jpg" alt=""></a>
								<div class="over-photo">
						...
						<li>
							<div class="item-box">
								<a class="strip" href="/static/images/resources/photo-88.jpg" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
									<img src="/static/images/resources/photo8.jpg" alt=""></a>
								<div class="over-photo">
				...
				<div class="central-meta">
					...
					<ul class="videos-list">
						<li>
							<div class="item-box">
								<a href="https://www.youtube.com/watch?v=fF382gwEnG8&amp;t=1s" title="" data-strip-group="mygroup" class="strip" data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img src="/static/images/resources/vid-11.jpg" alt="">
									<i>
						...
						<li>
							<div class="item-box">
								<a href="https://www.youtube.com/watch?v=fF382gwEnG8&amp;t=1s" title="" data-strip-group="mygroup" class="strip" data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img src="/static/images/resources/vid-12.jpg" alt="">
									<i>
										<svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
													  <path class="stroke-solid" fill="none" stroke="" d="M49.9,2.5C23.6,2.8,2.1,24.4,2.5,50.4C2.9,76.5,24.7,98,50.3,97.5c26.4-0.6,47.4-21.8,47.2-47.7
														C97.3,23.7,75.7,2.3,49.9,2.5"></path>
						...
						<li>
							<div class="item-box">
								<a href="https://www.youtube.com/watch?v=fF382gwEnG8&amp;t=1s" title="" data-strip-group="mygroup" class="strip" data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img src="/static/images/resources/vid-10.jpg" alt="">
									<i>
										<svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
													  <path class="stroke-solid" fill="none" stroke="" d="M49.9,2.5C23.6,2.8,2.1,24.4,2.5,50.4C2.9,76.5,24.7,98,50.3,97.5c26.4-0.6,47.4-21.8,47.2-47.7
														C97.3,23.7,75.7,2.3,49.9,2.5"></path>
						...
						<li>
							<div class="item-box">
								<a href="https://www.youtube.com/watch?v=fF382gwEnG8&amp;t=1s" title="" data-strip-group="mygroup" class="strip" data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img src="/static/images/resources/vid-9.jpg" alt="">
									<i>
										<svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
													  <path class="stroke-solid" fill="none" stroke="" d="M49.9,2.5C23.6,2.8,2.1,24.4,2.5,50.4C2.9,76.5,24.7,98,50.3,97.5c26.4-0.6,47.4-21.8,47.2-47.7
														C97.3,23.7,75.7,2.3,49.9,2.5"></path>
						...
						<li>
							<div class="item-box">
								<a href="https://www.youtube.com/watch?v=fF382gwEnG8&amp;t=1s" title="" data-strip-group="mygroup" class="strip" data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img src="/static/images/resources/vid-6.jpg" alt="">
									<i>
										<svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
													  <path class="stroke-solid" fill="none" stroke="" d="M49.9,2.5C23.6,2.8,2.1,24.4,2.5,50.4C2.9,76.5,24.7,98,50.3,97.5c26.4-0.6,47.4-21.8,47.2-47.7
														C97.3,23.7,75.7,2.3,49.9,2.5"></path>
